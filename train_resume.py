...
def train(encoder, 
    ...
    encOptimizer.load_state_dict(checkpoint['encOptimizer'])
    decOptimizer.load_state_dict(checkpoint['decOptimizer'])
...
if __name__ == "__main__":
    ...
    checkpoint = torch.load(gp.resumeLoadPath, map_location=device)
